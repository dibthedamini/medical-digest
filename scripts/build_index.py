#!/usr/bin/env python3
"""
build_index.py — Regenerate public/index.html from public/posts.json.
...
def generate_index_html(posts):
    ...
    for post in posts:
        ...
        read_min = max(1, round(len(summary) / 40))
...
def main():
    ...
    with open(INDEX_HTML, "w", encoding="utf-8") as f:
        f.write(html)
    print(f"✓ Generated {INDEX_HTML} with {len(posts)} posts")
